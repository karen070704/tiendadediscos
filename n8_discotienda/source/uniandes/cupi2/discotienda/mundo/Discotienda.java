...
public class Discotienda
{
    ...
    /**
     * generar un informe de todos los discos de un género dado por el usuario y que sean costosos
     * @throws FileNotFoundException
     */
    ...
    public void informeDiscosCostosos() throws FileNotFoundException
    {
    	...
    	//escribir la pluma en el archivo
    	
    	pluma.println("discosCostosos");
    	pluma.println("================");
    	
    	//recorrido total por los discos
    ...
    public String metodo1( )
    {
    	try {
        	...
        	return "Error no existe la ruta"+ e.getMessage();
        }
    }
